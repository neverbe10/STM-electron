  ...
  function (e, t, n) {
    ...
    window.onload = function () {
      ...
      (e.id = "bmc-wbtn"),
        ...
        "left" == a.dataset.position
          ? (e.style.left = a.dataset.x_margin + "px")
          : (e.style.right = a.dataset.x_margin + "px"),
        (e.style.bottom = a.dataset.y_margin + "px"),
        (e.style.boxShadow = "0 4px 8px rgba(0,0,0,.4)"),
        (e.innerHTML =
          '<img src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/snowman_2603.png" srcset="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/twitter/259/snowman_2603.png 2x" alt="Snowman on Twitter Twemoji 13.0.1" width="64" height="64">'),
        (e.style.zIndex = "9999"),
      ...
      (n.style.position = "fixed"),
        ...
        (n.style.border = "0"),
        "left" == a.dataset.position
          ? (n.style.left = a.dataset.x_margin + "px")
          : (n.style.right = a.dataset.x_margin + "px"),
      ...
      (o.style.position = "fixed"),
        ...
        (o.style.opacity = "0"),
        "left" == a.dataset.position
          ? (o.style.left = parseInt(a.dataset.x_margin, 10) + 84 + "px")
          : (o.style.right = parseInt(a.dataset.x_margin, 10) + 84 + "px"),
      ...
      (e.onclick = function () {
        s ||
          (n.src =
            ...
            a.dataset.id +
            "?description=" +
            encodeURIComponent(a.dataset.description) +
            "&color=" +
            encodeURIComponent(a.dataset.color)),
          s++,
          (o.style.opacity = "0"),
          (o.style.display = "none"),
          (t.style.width = "100%"),
